    ...
    <div className="flex min-h-[60vh] items-center justify-center">
      <CyberPanel className="w-full max-w-sm">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            <h2 className="pixel-heading text-xs text-[var(--color-accent)]">Create your account</h2>
            <p className="mt-1 text-xs text-[var(--color-text-muted)]">Start receiving daily trend intelligence — free</p>
          </div>
        </div>
        ...
        <div className="my-5 flex items-center gap-3">
          ...
          <span className="text-[10px] text-[var(--color-text-dim)]">or sign up with</span>
          <div className="h-px flex-1 bg-[var(--color-card-border)]" />
        </div>
