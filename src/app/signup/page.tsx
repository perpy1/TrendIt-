      ...
      >
        <div className="p-5">
          <div className="mb-4 flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-green-500 to-green-700">
              <Globe className="h-5 w-5 text-white" />
            </div>
            <div>
              <h2 className="text-sm font-bold text-[#1a1a1a]">Create your account</h2>
              <p className="text-[11px] text-[#555]">Start receiving daily trend intelligence — free</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              <label className="mb-1 block text-xs font-semibold text-[#333]">Display name:</label>
              <input
                type="text"
                value={displayName}
          ...
          <div className="my-4 flex items-center gap-3">
            ...
            <span className="text-[10px] text-[#888]">or sign up with</span>
            <div className="h-px flex-1 bg-[#d0d0d0]" />
          </div>
          ...
          <p className="mt-4 text-center text-[11px] text-[#555]">
            ...
            <Link href="/login" className="vista-link" onClick={playClick}>
              Sign in
            </Link>
          </p>
        </div>
