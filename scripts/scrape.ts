...
const CREATORS = [
  { id: "1", name: "Alex Hormozi", youtube_channel_id: "UCPr7L-CmPMHJIGEj_kyGnCw" },
  { id: "2", name: "Codie Sanchez", youtube_channel_id: "UCps1KSZG4ZSEFsPveSPaYjg" },
  { id: "3", name: "Gary Vee", youtube_channel_id: "UCctXZhXmQk4DAMBhnEAUPeg" },
  { id: "4", name: "Sahil Bloom", youtube_channel_id: "UC4MLhIsY6SaqXdSUx0q8nig" },
  { id: "5", name: "Dan Koe", youtube_channel_id: "UCPCYgVbDFUzUb7o9ijb2cBQ" },
  { id: "6", name: "Ali Abdaal", youtube_channel_id: "UCoOae5nYA7VqaXzerajD0lg" },
  { id: "7", name: "Iman Gadzhi", youtube_channel_id: "UCljd0ZzJJu-ExOZ7iOaKlwQ" },
  { id: "8", name: "Leila Hormozi", youtube_channel_id: "UCWyQ_Fxc1QsqymvIrJz6C1A" },
  { id: "9", name: "Chris Do", youtube_channel_id: "UCnmGIG8eLMOjg1Lmkgti51g" },
  { id: "10", name: "Mr Beast", youtube_channel_id: "UCX6OQ3DkcsbYNE6H8uQQuVA" },
  { id: "11", name: "Steven Bartlett", youtube_channel_id: "UCHnHWAi9URF38v0l-uOAR7w" },
  { id: "12", name: "Noah Kagan", youtube_channel_id: "UCx5UiKnbOBSqaRcABLKfFIA" },
  { id: "13", name: "Pat Flynn", youtube_channel_id: "UCGk1LnaSGlvsRFLnQfKJdcA" },
  { id: "14", name: "Ed Mylett", youtube_channel_id: "UCp3v0nGm7I6OSpRwgr8QCog" },
  ...
  { id: "27", name: "Vanessa Lau", youtube_channel_id: "UCbEKLXFrPx-cq3akIw9JA1w" },
  { id: "28", name: "Tim Ferriss", youtube_channel_id: "UCznv7Vf9nBdJYvBagFdAHWw" },
  { id: "29", name: "Russell Brunson", youtube_channel_id: "UCww7ov9cP1MNfpLFKW49VBw" },
  { id: "30", name: "Jay Shetty", youtube_channel_id: "UCbV60AGIHBmyFbKdgMal0Cg" },
  ...
  { id: "33", name: "Mark Tilbury", youtube_channel_id: "UCzIXh4fzOfEaDhauD6eGZdA" },
  { id: "34", name: "Coin Bureau (Guy)", youtube_channel_id: "UCqK_GSMbpiV8spgD3ZGloSw" },
  { id: "35", name: "Grant Cardone", youtube_channel_id: "UCJXmf9RQMB9Ei6CwTz7Umhg" },
];
